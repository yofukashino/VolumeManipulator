...
export const Settings = (): React.ReactElement => {
  const [multiplier, onMultiplierChange] =util.useSettingArray(SettingValues, "multiplier", DefaultSettings.multiplier)
 return  <div>
    <Slider
    label="Max Volume Multiplier"
      description={`The max threshold for volume. (Default: 200, Current: ${
        200 * multiplier
      })`}
